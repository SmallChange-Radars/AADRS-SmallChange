...
describe('PortfolioService', () => {
  ...
  it('should get widget list', inject([PortfolioService], fakeAsync((service: PortfolioService) => {
    ...
    const req = httpTestingController.expectOne('http://localhost:8080/api/portfolio');
  ...
  it('should handle 404 error', inject([PortfolioService], ((service: PortfolioService) => {
    ...
    httpTestingController.verify();
    expect(errorReply).toBe('Unable to contact portfolio service; Please try again later');
